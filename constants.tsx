...
export const ICONS = {
  ...
  LionLogo: ({ className }: { className?: string }) => (
    <svg viewBox="0 0 500 500" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M250 50 L450 175 L450 325 L250 450 L50 325 L50 175 Z" fill="none" stroke="#ED117E" strokeWidth="15"/>
      <path d="M250 140 C250 140 210 170 190 220 C170 270 190 320 250 400 C310 320 330 270 310 220 C290 170 250 140 250 140 Z" fill="#ED117E"/>
    </svg>
  )
};
